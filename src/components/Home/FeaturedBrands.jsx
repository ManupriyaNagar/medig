    ...
    <section className="py-12 bg-gray-50">
      <div className="container mx-auto px-4">
        <div className="text-center mb-10">
          <h2 className="text-2xl font-bold text-gray-800 mb-2">Featured Brands</h2>
          <p className="text-gray-600">Trusted healthcare brands we partner with</p>
        </div>
        ...
        {/* Brand Categories */}
        <div className="mt-12">
          <h3 className="text-xl font-semibold text-center mb-6">Shop by Brand Category</h3>
          
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
            <div className="bg-white rounded-lg overflow-hidden shadow-sm hover:shadow-md transition-shadow">
              <div className="p-5 border-b">
                <h4 className="font-semibold text-lg">Ayurvedic Brands</h4>
            ...
            <div className="bg-white rounded-lg overflow-hidden shadow-sm hover:shadow-md transition-shadow">
              <div className="p-5 border-b">
                <h4 className="font-semibold text-lg">Pharmaceutical Giants</h4>
