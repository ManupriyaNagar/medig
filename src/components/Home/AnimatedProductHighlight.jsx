...
export default function AnimatedProductHighlight() {
  ...
  return (
    <div 
      ref={containerRef}
      className="relative py-24 overflow-hidden  my-16"
    >
      ...
      <div className="container mx-auto px-4 relative z-20">
        <motion.div 
          ...
          style={{ opacity, scale }}
        >
          <h2 className="text-3xl md:text-4xl font-bold mb-4 text-blue-900">Premium Health Products</h2>
          <p className="text-lg text-blue-700 max-w-2xl mx-auto">Discover our carefully selected range of premium health products designed to enhance your wellbeing</p>
        </motion.div>
        
        <div className="flex flex-col md:flex-row justify-between items-center gap-8">
          {/* Product 1 */}
          <motion.div 
            className="bg-white rounded-2xl shadow-xl p-6 md:w-1/3 relative z-10 border border-blue-100"
            style={{ y: y1 }}
          >
            <div className="bg-blue-50 rounded-xl p-4 mb-6 flex justify-center">
              <Image 
                src="/img1.webp" 
            ...
            <h3 className="text-xl font-bold mb-2 text-blue-800">Immune Support Complex</h3>
            <p className="text-gray-600 mb-4">Advanced formula with Vitamin C, D, Zinc and Elderberry</p>
          ...
          {/* Product 2 */}
          <motion.div 
            className="bg-white rounded-2xl shadow-xl p-6 md:w-1/3 relative z-20 border border-blue-100 md:mt-12"
            style={{ y: y2 }}
          >
            <div className="bg-green-50 rounded-xl p-4 mb-6 flex justify-center">
              <Image 
                src="/img1.webp" 
            ...
            <h3 className="text-xl font-bold mb-2 text-green-800">Ayurvedic Wellness Blend</h3>
            <p className="text-gray-600 mb-4">Traditional herbs for natural immunity and vitality</p>
            <div className="flex justify-between items-center">
          ...
          >
            ...
            <h3 className="text-xl font-bold mb-2 text-purple-800">Premium Protein Formula</h3>
            <p className="text-gray-600 mb-4">High-quality protein with essential amino acids</p>
            <div className="flex justify-between items-center">
              <span className="text-2xl font-bold text-purple-600">₹899</span>
              <motion.button 
            ...
            <div className="absolute -top-3 -right-3 bg-blue-500 text-white text-sm font-bold px-3 py-1 rounded-full shadow-lg">
              BESTSELLER
            </div>
          </motion.div>
        </div>
