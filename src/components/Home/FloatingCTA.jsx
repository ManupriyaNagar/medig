      ...
      {isVisible && (
        ...
        >
          <div className="bg-white rounded-xl sm:rounded-2xl shadow-2xl overflow-hidden w-full border border-blue-100">
            <div className="bg-gradient-to-r from-[#71AA49] to-[#2DAAE0] px-4 sm:px-6 py-3 sm:py-4 flex justify-between items-center">
            ...
            <div className="p-4 sm:p-6">
              ...
              >
                ...
                <motion.button
                  className="w-full py-2 sm:py-3 rounded-lg bg-[#2DAAE0] text-white text-sm sm:text-base font-medium hover:bg-[#71AA49] transition-colors shadow-md"
